...
<section class="card">
    <h1>Quan ly muon tra</h1>
    <p class="lead">Xu ly cac yeu cau muon va tra sach cua doc gia.</p>
</section>
                ...
                <tr>
                    ...
                    <td>
                        <c:if test="${request.status == 'PENDING'}">
                            <form method="post"
                                  action="${pageContext.request.contextPath}/librarian/borrow-requests/status"
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <c:if test="${empty records}">
                <tr>
                    <td colspan="7">Chua co phieu muon nao.</td>
                </tr>
            </c:if>
        </tbody>
    </table>
